...
public class PrimeraActivity extends AppCompatActivity {
    ...
    protected Button botonazo, botonCrearCuidadores, botonReservas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonReservas = (Button) findViewById(R.id.botonReservas_primera);
        ...
        botonReservas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pasarPantalla = new Intent(PrimeraActivity.this, VerReservasActivity.class);
                pasarPantalla.putExtra("IDUSUARIO", 1);
                startActivity(pasarPantalla);
            }
        });
    }
